    ...
    <div className="min-h-screen bg-gradient-subtle">
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="text-center mb-16 animate-fade-in">
          <div className="inline-flex items-center space-x-2 mb-6 px-4 py-2 rounded-full bg-primary/5 border border-primary/10">
      ...
      <footer className="border-t border-border/50 bg-surface/50 mt-24">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center text-sm text-muted-foreground">
            <p>© 2024 Thesis Archive System. Empowering academic research discovery.</p>
          </div>
        </div>
      </footer>
    </div>
